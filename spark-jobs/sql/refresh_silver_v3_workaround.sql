-- ============================================================================
-- КОСТЫЛЬ: Пересборка Silver слоя с джойном старых и новых записей
-- Берём: data из op='r' (старые), signature из op='u' (новые замаскированные)
...
-- Проверка маскировки company_tin
SELECT
